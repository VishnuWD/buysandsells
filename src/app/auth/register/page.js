...
function page() {
  ...
  return (
    ...
    <div className='flex justify-center items-center text-slate-800 h-[calc(100vh-10vh)]'>
      ...
      <form action="/" className='flex flex-col' method='POST'>

        <h1 className='text-center text-5xl font-bold mb-8'>Register</h1>

        <label className='text-sm' htmlFor="name">Name: </label>
        <input className='border-2 text-base rounded-lg py-2 px-3 mb-4' value={val}
          onChange={handleInputChange} id='username' type="text" placeholder='Market@mail.com' />

        <input className='hidden' type="text" value={`https://ui-avatars.com/api/?bold=true&background=random&name=${val}`} />
